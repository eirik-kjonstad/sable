...
KEYWORDS: frozenset[str] = frozenset({
    "program", "end", "module", "submodule", "use", "implicit", "none",
    "integer", "real", "complex", "logical", "character", "type", "class",
    "double", "precision",
    "if", "then", "else", "elseif", "end if", "endif",
    "do", "while", "end do", "enddo", "cycle", "exit",
    ...
    "block", "critical", "flush", "sync",
    "print", "write", "read", "open", "close", "format",
    "allocate", "deallocate", "nullify",
    "pure", "elemental", "recursive", "impure",
    "abstract", "extends", "deferred", "non_overridable",
    "bind", "sequence", "enumerator", "enum",
    "forall", "where", "elsewhere", "end where",
})
